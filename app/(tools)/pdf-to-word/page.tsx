...
export default function PDFToWordPage() {
  ...
  return (
    <ToolLayout
      title="PDF to Word"
      description="Extract text from your PDF and save it as an editable .docx file."
      icon="description"
    ...
    >
      <div className="space-y-4">
        ...
        <div className="p-4 bg-amber-50 border border-amber-200 rounded text-sm text-amber-700">
          <p className="font-semibold mb-1">Client-side extraction limitations</p>
          <p>
            Text and paragraph structure are extracted from the PDF&apos;s text layer. Complex layouts,
            tables, and images are not preserved. For scanned PDFs with no text layer, use the{" "}
            <a href="/ocr-pdf" className="underline font-medium">OCR tool</a> first.
          </p>
        </div>
