...
export default function JPGToPDFPage() {
  ...
  return (
    <ToolLayout
      title="JPG to PDF"
      description="Pack one or more images into a single PDF file."
          ...
          <ToolCard>
            ...
            >
              ...
              <div className="text-center">
                <p className="font-medium text-slate-700">Drop images here</p>
                <p className="text-sm text-slate-500 mt-0.5">JPG, PNG, WebP, BMP - click to select</p>
              </div>
            </div>
          </ToolCard>
                ...
                {files.map((f, i) => (
                  ...
                  >
                    ...
                    <button
                      ...
                      className="absolute top-1 right-1 w-5 h-5 bg-white rounded-full text-slate-600 hover:text-red-600 shadow flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity"
                    >
